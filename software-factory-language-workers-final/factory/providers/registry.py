...
def build_provider_for_spec(settings, provider_name, model) -> AIProvider:
    ...
    key_map={'openai':'OPENAI_API_KEY','openai-compatible':'OPENAI_API_KEY','gemini':'GEMINI_API_KEY','google':'GEMINI_API_KEY','anthropic':'ANTHROPIC_API_KEY','groq':'GROQ_API_KEY','openai-responses':'OPENAI_API_KEY','codex':'OPENAI_API_KEY'}
