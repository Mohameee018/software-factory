...
ROLE_CONTRACTS: dict[str, EmployeeContract] = {
    ...
    "techlead": EmployeeContract("techlead","Technical Lead","Own implementation coherence across developers and architecture.",
        ("define implementation standards","resolve technical conflicts","review cross-cutting changes"),("ARCHITECTURE.md","TASKS.md"),("technical decisions","implementation standards"),("architecture","code-review","mentoring"),
        frozenset({"read_architecture","read_source","set_implementation_standards"}),("architecture_coverage","implementation_evidence"),"manager"),
    "devops": EmployeeContract("devops","DevOps Engineer","Make builds, environments and delivery reproducible.",
        ("define CI/CD","environment configuration","deployment automation","observability"),("architecture","source","deployment_constraints"),("deployment_config","CI","release_evidence"),("devops","ci-cd","observability"),
        frozenset({"read_source","write_ci","write_deployment_config"}),("deployment_evidence",),"manager"),
    "writer": EmployeeContract("writer","Technical Writer","Turn verified behavior into usable documentation.",
        ("document setup","document APIs","document release behavior"),("source","acceptance_criteria","release_evidence"),("documentation","API docs","technical-writing"),
        frozenset({"read_project","write_docs"}),("documentation_quality",),"manager"),
    "handoff": EmployeeContract("handoff","Client Handoff","Package the verified product and evidence for the client.",
        ("assemble delivery package","summarize known limitations","provide run instructions"),("release_evidence","documentation","audit"),("HANDOFF.md",),("handoff","technical-writing"),
        frozenset({"read_release_artifacts","write_handoff"}),("final_gate",),"client"),
