...
class WorkflowState(str, Enum):
    IDEA='IDEA'; REQUIREMENTS_GATHERING='REQUIREMENTS_GATHERING'; WAITING_FOR_REQUIREMENTS_APPROVAL='WAITING_FOR_REQUIREMENTS_APPROVAL'; DESIGNING='DESIGNING'; WAITING_FOR_DESIGN_APPROVAL='WAITING_FOR_DESIGN_APPROVAL'; DESIGN_APPROVED='DESIGN_APPROVED'; PLANNING='PLANNING'; DOCUMENTATION='DOCUMENTATION'; ANALYSIS='ANALYSIS'; ARCHITECTURE='ARCHITECTURE'; TASK_CREATION='TASK_CREATION'; IMPLEMENTATION='IMPLEMENTATION'; TESTING='TESTING'; REVIEWING='REVIEWING'; UX_REVIEW='UX_REVIEW'; SECURITY_REVIEW='SECURITY_REVIEW'; FIXING='FIXING'; READY_FOR_HUMAN='READY_FOR_HUMAN'; CHANGES_REQUESTED='CHANGES_REQUESTED'; COMPLETED='COMPLETED'; PAUSED='PAUSED'; WAITING_FOR_QUOTA='WAITING_FOR_QUOTA'; BLOCKED='BLOCKED'; FAILED='FAILED'; CANCELLED='CANCELLED'
