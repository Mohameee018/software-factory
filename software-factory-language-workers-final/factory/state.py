...
TRANSITIONS={
 WorkflowState.IDEA:{WorkflowState.DESIGNING,WorkflowState.BLOCKED,WorkflowState.CANCELLED,WorkflowState.PAUSED,WorkflowState.WAITING_FOR_QUOTA},
 ...
 WorkflowState.REVIEWING:{WorkflowState.UX_REVIEW,WorkflowState.FIXING,WorkflowState.BLOCKED,WorkflowState.FAILED,WorkflowState.PAUSED},
